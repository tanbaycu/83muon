    ...
    if (navigator.share) {
        try {
            await navigator.share({
                title: `💌 Có 1 tin nhắn ẩn danh mừng 8/3 đang chờ bạn mở!`,
                text: `Vũ trụ gửi tín hiệu ✨ Có 1 bí mật ẩn danh dành cho ${girlData?.name || 'bạn'}. Bấm vào để khám phá món quà 8/3 nhé!`,
                url: shareUrl,
            });
        } catch (err) {
